...
import sanchez.sanchez.sergio.agrociety.ui.features.main.search.categories.user.SearchUserViewModel
...
abstract class SearchUserModule {
    ...
    abstract fun bindsSearchUserViewModel(searchUserViewModel: SearchUserViewModel): ViewModel
