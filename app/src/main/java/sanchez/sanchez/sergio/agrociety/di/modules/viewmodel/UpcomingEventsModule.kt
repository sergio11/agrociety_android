...
import sanchez.sanchez.sergio.agrociety.ui.features.main.home.upcomingevents.UpcomingEventsViewModel
...
abstract class UpcomingEventsModule {

    @PerFragment
    @Binds
    @IntoMap
    @ViewModelKey(UpcomingEventsViewModel::class)
    abstract fun bindsUpcomingEventsViewModel(upcomingEventsViewModel: UpcomingEventsViewModel): ViewModel
