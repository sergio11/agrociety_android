...
import sanchez.sanchez.sergio.agrociety.ui.features.main.settings.UserSettingsViewModel
...
abstract class UserSettingsModule {
    ...
    abstract fun bindsUserSettingsViewModel(userSettingsViewModel: UserSettingsViewModel): ViewModel
}