...
import sanchez.sanchez.sergio.agrociety.ui.features.main.search.categories.announcements.SearchAnnouncementsViewModel
...
abstract class SearchAnnouncementsModule {

    @PerFragment
    @Binds
    @IntoMap
    @ViewModelKey(SearchAnnouncementsViewModel::class)
    abstract fun bindsSearchAnnouncementsViewModel(searchAnnouncementsViewModel: SearchAnnouncementsViewModel): ViewModel
